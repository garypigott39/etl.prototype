...
-- DROP FUNCTION IF EXISTS ce_warehouse.fx_val__is_flag;

CREATE OR REPLACE FUNCTION ce_warehouse.fx_val__is_flag(
    _val TEXT,
...
COMMENT ON FUNCTION ce_warehouse.fx_val__is_flag
