 ...
 ***********************************************************************************************************
 * @file
 * fx_tg__c_series__check_icode.sql
 *
...
-- DROP FUNCTION IF EXISTS ce_warehouse.fx_tg__c_series__check_icode;

CREATE OR REPLACE FUNCTION ce_warehouse.fx_tg__c_series__check_icode(
)
    RETURNS TRIGGER
    LANGUAGE plpgsql
AS
...
COMMENT ON FUNCTION ce_warehouse.fx_tg__c_series__check_icode
