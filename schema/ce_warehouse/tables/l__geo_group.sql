...
-- DROP TABLE IF EXISTS ce_warehouse.l__geo_group;

CREATE TABLE IF NOT EXISTS ce_warehouse.l__geo_group
(
    pk_geo_group SMALLINT NOT NULL GENERATED BY DEFAULT AS IDENTITY,
    ...
    PRIMARY KEY (pk_geo_group),
    UNIQUE (code),
    UNIQUE (name)
);

COMMENT ON TABLE ce_warehouse.l__geo_group
