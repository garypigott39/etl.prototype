 ...
 ***********************************************************************************************************
 * @file
 * fx_tg__generic__audit.sql
 *
 * Trigger function - log changes to generic audit (AFTER update).
 ***********************************************************************************************************
 */

-- DROP FUNCTION IF EXISTS ce_warehouse.fx_tg__generic__audit;

CREATE OR REPLACE FUNCTION ce_warehouse.fx_tg__generic__audit(
)
    RETURNS TRIGGER
    LANGUAGE plpgsql
AS
...
COMMENT ON FUNCTION ce_warehouse.fx_tg__generic__audit
