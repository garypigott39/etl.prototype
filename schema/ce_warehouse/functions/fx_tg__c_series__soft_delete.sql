 ...
 ***********************************************************************************************************
 * @file
 * fx_tg__c_series__soft_delete.sql
 *
 * Trigger function - soft delete on c_series record (BEFORE DELETE).
 ***********************************************************************************************************
 */

-- DROP FUNCTION IF EXISTS ce_warehouse.fx_tg__c_series__soft_delete;

CREATE OR REPLACE FUNCTION ce_warehouse.fx_tg__c_series__soft_delete(
)
    RETURNS TRIGGER
    LANGUAGE plpgsql
AS
...
COMMENT ON FUNCTION ce_warehouse.fx_tg__c_series__soft_delete
