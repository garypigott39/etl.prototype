...
(
    ...
    code TEXT NOT NULL
        CHECK (ce_warehouse.fx_val_is_code(code, 'c_ind.code', FALSE) IS NULL),
    name TEXT NOT NULL
        CHECK (ce_warehouse.fx_val_is_name(name, 'c_ind.name', FALSE) IS NULL),
    description TEXT
        CHECK (ce_warehouse.fx_val_is_text(description, 'c_ind.description') IS NULL),
    name1 TEXT
    ...
    name_lower TEXT
        CHECK (ce_warehouse.fx_val_is_name(name_lower, 'c_ind.name_lower.ignore_case') IS NULL),
    name1_lower TEXT
        CHECK (ce_warehouse.fx_val_is_name(name1_lower, 'c_ind.name1_lower.ignore_case') IS NULL),
    name2_lower TEXT
        CHECK (ce_warehouse.fx_val_is_name(name2_lower, 'c_ind.name2_lower.ignore_case') IS NULL),
    name3_lower TEXT
