...
-- DROP TABLE IF EXISTS ce_warehouse.l__stock_market;

CREATE TABLE IF NOT EXISTS ce_warehouse.l__stock_market
(
    pk_stock_market INT NOT NULL GENERATED BY DEFAULT AS IDENTITY,
...
COMMENT ON TABLE ce_warehouse.l__stock_market
