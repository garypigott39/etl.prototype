...
-- DROP TRIGGER IF EXISTS tg_x_value_audit ON ce_etl.x_value;

CREATE TRIGGER tg_x_value_audit
    AFTER INSERT OR UPDATE OR DELETE ON ce_etl.x_value
    FOR EACH ROW EXECUTE FUNCTION ce_etl.fx_tg_x_value_audit();
