...
(
    ...
    freq SMALLINT NOT NULL
        GENERATED ALWAYS AS (pdi / 100000000) STORED,  -- extract frequency from period code
    source TEXT NOT NULL,
    value NUMERIC NOT NULL,
    fk_pk_tip INT
        REFERENCES ce_etl.x_tooltip (pk_tip),  -- optional tooltip reference
    is_calculated BOOLEAN NOT NULL
        GENERATED BY DEFAULT AS (source ~ '^X'),  -- flag to indicate if the value is calculated
