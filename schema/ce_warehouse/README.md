...
| `fx_tb__pg__`     | Postgres table function   | `fx_tg__pg__`                 | Function returning (a table of) Postres info               |
...
| Triggers          |                           |                               |                                                            |
| `tg__`            | Trigger                   | `tg__cseries__b01`            | This example is an initial before action on table c_series |
|                   |                           | `tg__cseries__a01`            | and this would be example of an after action               |
| Views             |                           |                               |                                                            |
