 ...
 ***********************************************************************************************************
 * @file
 * l__ind_category_narrow.sql
 *
 * Lookup table - IND narrow category lookup.
 ***********************************************************************************************************
 */

-- DROP TABLE IF EXISTS ce_warehouse.l__ind_category_narrow;

CREATE TABLE IF NOT EXISTS ce_warehouse.l__ind_category_narrow
(
...
COMMENT ON TABLE ce_warehouse.l__ind_category_narrow
