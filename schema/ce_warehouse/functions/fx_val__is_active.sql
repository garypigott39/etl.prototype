 ...
 ***********************************************************************************************************
 * @file
 * fx_val__is_active.sql
 *
 * Validation function - check if parent (series/geo or com/ind) is active.
 ***********************************************************************************************************
 */

-- DROP FUNCTION IF EXISTS ce_warehouse.fx_val__is_active;

CREATE OR REPLACE FUNCTION ce_warehouse.fx_val__is_active(
    _code TEXT,
    _type TEXT,
...
COMMENT ON FUNCTION ce_warehouse.fx_val__is_active
