 ...
 ***********************************************************************************************************
 * @file
 * fx_tg_generic__check_block_internal.sql
 *
...
-- DROP FUNCTION IF EXISTS ce_warehouse.fx_tg_generic__check_block_internal;

CREATE OR REPLACE FUNCTION ce_warehouse.fx_tg_generic__check_block_internal(
)
    RETURNS TRIGGER
    LANGUAGE plpgsql
AS
...
COMMENT ON FUNCTION ce_warehouse.fx_tg_generic__check_block_internal
