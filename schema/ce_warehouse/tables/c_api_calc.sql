...
(
    ...
    ca_target_freq_int INT[] GENERATED ALWAYS
        AS (ce_warehouse.fx_ut_ifreq_multi(ca_target_freq)) STORED,
    ca_source_series TEXT NOT NULL,  -- Source Series ID, cant be based on "calculated"
    ca_source_freq TEXT NOT NULL,  -- Source Frequency
    ca_source_freq_int INT GENERATED ALWAYS
        AS (ce_warehouse.fx_ut_ifreq_single(ca_source_freq)) STORED,
