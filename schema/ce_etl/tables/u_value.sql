...
-- DROP TABLE IF EXISTS ce_etl.u_value;

CREATE TABLE IF NOT EXISTS ce_etl.u_value
(
...
CREATE INDEX IF NOT EXISTS u_value__datapoint__idx
    ON ce_etl.u_value (uv_gcode, uv_icode, uv_period);

COMMENT ON TABLE ce_etl.u_value
