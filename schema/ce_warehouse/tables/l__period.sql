...
(
    ...
    dt_start_of_period DATE NOT NULL
        CHECK (ce_warehouse.fx_val__is_start_date(dt_start_of_period, ifreq) IS NULL),

    dt_end_of_period DATE NOT NULL,  -- Calculated on the way in, as used in GENERATED columns below
