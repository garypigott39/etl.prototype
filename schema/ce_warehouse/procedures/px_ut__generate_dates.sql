 ...
 ***********************************************************************************************************
 * @file
 * px_ut__generate_dates.sql
 *
 * Utility procedure - generate missing dates & periods.
 ***********************************************************************************************************
 */

-- DROP PROCEDURE IF EXISTS ce_warehouse.px_ut__generate_dates;

CREATE OR REPLACE PROCEDURE ce_warehouse.px_ut__generate_dates(
)
    LANGUAGE plpgsql
AS
$$
...
COMMENT ON PROCEDURE ce_warehouse.px_ut__generate_dates
