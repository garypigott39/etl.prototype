 ...
 ***********************************************************************************************************
 * @file
 * fx_val__is_start_date.sql
 *
 * Validation function - check if supplied date is the start date of a period.
 ***********************************************************************************************************
 */

-- DROP FUNCTION IF EXISTS ce_warehouse.fx_val__is_start_date;

CREATE OR REPLACE FUNCTION ce_warehouse.fx_val__is_start_date(
    _dt DATE,
    _ifreq INT,
...
COMMENT ON FUNCTION ce_warehouse.fx_val__is_start_date
