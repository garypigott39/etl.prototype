 ...
 *
 * e.g. IF ce_warehouse.fx_ut_is_db('testdb') THEN ...
 ***********************************************************************************************************
 */

-- DROP FUNCTION IF EXISTS ce_warehouse.fx_ut_is_db;

CREATE OR REPLACE FUNCTION ce_warehouse.fx_ut_is_db(
    _name TEXT
)
    RETURNS BOOL
    LANGUAGE sql
...
COMMENT ON FUNCTION ce_warehouse.fx_ut_is_db
