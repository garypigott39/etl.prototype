...
-- DROP TABLE IF EXISTS ce_warehouse.s__text_rule;

CREATE TABLE IF NOT EXISTS ce_warehouse.s__text_rule
(
    ...
    is_allow_consecutive_ws BOOL NOT NULL DEFAULT FALSE,
    is_allow_leading_or_trailing_ws BOOL NOT NULL DEFAULT FALSE,
    is_allow_unbalanced_parenthesis BOOL NOT NULL DEFAULT FALSE,
