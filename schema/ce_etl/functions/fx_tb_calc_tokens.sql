...
-- DROP FUNCTION IF EXISTS ce_etl.fx_tb_calc_tokens;

CREATE OR REPLACE FUNCTION ce_etl.fx_tb_calc_tokens(
    _calc_table TEXT DEFAULT 'ce_etl.c_calc',
    _const_table TEXT DEFAULT 'ce_etl.c_const'
)
    RETURNS TABLE (
        series TEXT,
        tokens TEXT[]
